...
function MyApp(props){
  ...
  //added version1 setUser = (user) => {
  //original  setState({ user });
  //added version1
  //setCurrentUser( {user} )
  // };
  //end
  ...
  return (
    <AppContext.Provider value={
      ...
      //original user: currentUser.user,
      //setUser: setUser,
      //end

    //added version1 isAuthenticated:false,user:null,setUser:()=>{}
    //end
    //added
    isAuthenticated,user,setUser, setIsAuthenticated, notification, setNotification
  }}>
      <Head>
        <link
          rel="stylesheet"
